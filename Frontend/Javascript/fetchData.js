...
fetch("http://localhost:7070/getParicipantTraps")
  ...
  .then((data) => {
    // console.log();
    document
      .getElementById(data[0].thinkingtraps_idThinkingTraps)
      .classList.add("activeButton");
    document
      .getElementById(data[1].thinkingtraps_idThinkingTraps)
      .classList.add("activeButton");
    document
      .getElementById(data[2].thinkingtraps_idThinkingTraps)
      .classList.add("activeButton");
