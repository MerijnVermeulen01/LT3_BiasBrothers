...
function buttonTextToArray(textAreaId, participantText) {
  if (textAreaId === "buttonWrite1") {
    writeButton[0] = participantText;
  } else if (textAreaId === "buttonWrite2") {
    writeButton[1] = participantText;
  } else if (textAreaId === "buttonWrite3") {
    writeButton[2] = participantText;
  } else if (textAreaId === "buttonWrite4") {
    writeButton[3] = participantText;
  } else if (textAreaId === "buttonWrite5") {
    writeButton[4] = participantText;
  } else if (textAreaId === "buttonWrite6") {
    writeButton[5] = participantText;
  }
}
