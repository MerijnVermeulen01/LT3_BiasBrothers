...
const headers = [
  document.getElementById("textHeader1"),
  document.getElementById("textHeader2"),
...
fetch("http://localhost:7070/getParicipantBias")
  ...
  .then((data) => {
    document
      .getElementById(data[0].bias_idBiases)
      .classList.add("activeButton");
    document
      .getElementById(data[1].bias_idBiases)
      .classList.add("activeButton");
    document
      .getElementById(data[2].bias_idBiases)
      .classList.add("activeButton");
